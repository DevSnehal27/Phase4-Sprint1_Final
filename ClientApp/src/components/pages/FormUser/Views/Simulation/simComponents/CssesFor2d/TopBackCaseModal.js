    ...
    return (
        <>
            ...
            <mesh rotation={[angleRadians(180), -angleRadians(180), -angleRadians(90)]}
                position={[-(props.Case_Width / 2.5), -(props.Case_Height / 2.2), (props.Case_Length / 2)]} castShadow receiveShadow>
            ...
            <mesh rotation={[angleRadians(90), -angleRadians(180), -angleRadians(90)]}
                position={[(props.Case_Width / 2), (props.Case_Height / 2), ((props.Case_Length / 2.25))]} castShadow receiveShadow>
...
export default TopBackCaseModal;