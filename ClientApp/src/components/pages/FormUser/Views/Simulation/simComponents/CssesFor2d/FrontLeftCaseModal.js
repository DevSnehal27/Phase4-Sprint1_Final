...
const FrontLeftCaseModal = (props) => {
    ...
    return (
        <>
            ...
            <PerspectiveCamera position={[-((props.Case_Height + props.Case_Length + props.Case_Width)), ((props.Case_Height + props.Case_Length + props.Case_Width)), ((props.Case_Height + props.Case_Length + props.Case_Width))+0.2]} makeDefault />
            ...
            <mesh rotation={[angleRadians(180), -angleRadians(90), -angleRadians(180)]}
                position={[-(props.Case_Length / 2), -(props.Case_Height / 1.9), -((props.Case_Width / 2))]} castShadow receiveShadow>
            ...
            <mesh rotation={[angleRadians(180), -angleRadians(90), -angleRadians(90)]}
                position={[-(props.Case_Length / 2), -(props.Case_Height / 2.2), -((props.Case_Width / 2.5))]} castShadow receiveShadow>
            ...
            <mesh rotation={[angleRadians(180), -angleRadians(180), -angleRadians(90)]}
                position={[-(props.Case_Length / 2.5), -(props.Case_Height / 2.2), (props.Case_Width / 2)]} castShadow receiveShadow>
            ...
            <mesh ref={frontLeft} rotation={[0, Math.PI / 2, 0]}
...
export default FrontLeftCaseModal;